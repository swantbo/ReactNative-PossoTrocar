  ...
  return (
    <ScrollView>
      ...
      <Text style={{ textAlign: "center", padding: 5 }}>
        A sua privacidade é importante para nós. É política do Posso Trocar
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site Posso Trocar, e outros sites que possuímos e
        operamos.
      </Text>
      <Text style={{ textAlign: "center", padding: 5 }}>
      ...
      <Text style={{ textAlign: "center", padding: 5 }}>
        Política de Cookies Posso Trocar O que são cookies? Como é prática comum
      ...
      <Text style={{ textAlign: "center", padding: 5 }}>
        Desativar cookies Você pode impedir a configuração de cookies ajustando
        as configurações do seu navegador (consulte a Ajuda do navegador para
        saber como fazer isso). Esteja ciente de que a desativação de cookies
        afetará a funcionalidade deste e de muitos outros sites que você visita.
        A desativação de cookies geralmente resultará na desativação de
        determinadas funcionalidades e recursos deste site. Portanto, é
        recomendável que você não desative os cookies.
      </Text>

      <Text style={{ textAlign: "center", padding: 5 }}>
        Cookies que definimos Cookies relacionados à conta Se você criar uma
        conta connosco, usaremos cookies para o gerenciamento do processo de
      ...
      <Text style={{ textAlign: "center", padding: 5 }}>
        Cookies relacionados a boletins por e-mail Este site oferece serviços de
        assinatura de boletim informativo ou e-mail e os cookies podem ser
      ...
      <Text style={{ textAlign: "center", padding: 5 }}>
        Pedidos processando cookies relacionados Este site oferece facilidades
        de comércio eletrônico ou pagamento e alguns cookies são essenciais para
        garantir que seu pedido seja lembrado entre as páginas, para que
        possamos processá-lo adequadamente.
      </Text>

      <Text style={{ textAlign: "center", padding: 5 }}>
        Cookies relacionados a pesquisas Periodicamente, oferecemos pesquisas e
        questionários para fornecer informações interessantes, ferramentas úteis
        ou para entender nossa base de usuários com mais precisão. Essas
      ...
      <Text style={{ textAlign: "center", padding: 5 }}>
        Cookies relacionados a formulários Quando você envia dados por meio de
      ...
      <Text style={{ textAlign: "center", padding: 5 }}>
        Cookies de preferências do site Para proporcionar uma ótima experiência
        neste site, fornecemos a funcionalidade para definir suas preferências
        de como esse site é executado quando você o usa. Para lembrar suas
        preferências, precisamos definir cookies para que essas informações
        possam ser chamadas sempre que você interagir com uma página for afetada
        por suas preferências.
      </Text>

      <Text style={{ textAlign: "center", padding: 5 }}>
        Cookies de Terceiros Em alguns casos especiais, também usamos cookies
        fornecidos por terceiros confiáveis. A seção a seguir detalha quais
      ...
      <Text style={{ textAlign: "center", padding: 5 }}>
        ...
        site para você. Periodicamente, testamos novos recursos e fazemos
        alterações subtis na maneira como o site se apresenta. Quando ainda
        estamos testando novos recursos, esses cookies podem ser usados para
        garantir que você receba uma experiência consistente enquanto estiver no
        site, enquanto entendemos quais otimizações os nossos usuários mais
        apreciam. À medida que vendemos produtos, é importante entendermos as
        estatísticas sobre quantos visitantes de nosso site realmente compram e,
        portanto, esse é o tipo de dados que esses cookies rastrearão. Isso é
        importante para você, pois significa que podemos fazer previsões de
        ...
        Compromisso do Usuário O usuário se compromete a fazer uso adequado dos
        conteúdos e da informação que o Posso Trocar oferece no site e com
      ...
      <Text style={{ textAlign: "center", padding: 5 }}>
        ...
        jogos de hoje ou azar, qualquer tipo de pornografia ilegal, de apologia
        ao terrorismo ou contra os direitos humanos;
      </Text>

      <Text style={{ textAlign: "center", padding: 5 }}>
        C) Não causar danos aos sistemas físicos (hardwares) e lógicos
        (softwares) do Posso Trocar, de seus fornecedores ou terceiros, para
